...
import { CONTRACT_ADDRESSES, VAULT_MANAGER_ABI } from '../constants/contracts';
        ...
        try {
          ...
          for (const event of depositEvents) {
            ...
            try {
              ...
              console.error(`Error getting deposit count for user ${user}:`, err);
            }
          }
        } catch (err) {
          console.warn('Could not load deposits from events, contract might not have any deposits yet:', err);
        }
  ...
  if (!isConnected) {
    return (
      <div className="bg-gray-800 rounded-lg p-6">
        <h2 className="text-xl font-bold mb-4">Vault Admin Panel</h2>
        <p>Please connect your wallet to access the vault admin panel.</p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gray-800 rounded-lg p-6">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold">Vault Deposits Management</h2>
        ...
        {loading ? (
          ...
          <p>No deposits found. Users may not have made any deposits yet.</p>
        ) : (
        ...
        <div className="mt-6 p-4 bg-gray-700/30 border border-gray-600 rounded">
          <h3 className="text-sm font-medium mb-2">Vault Admin Functions</h3>
          <div className="text-xs text-gray-400 space-y-1">
            ...
            <p><span className="text-purple-400">Backend Control:</span> This simulates how your backend would manage profit/loss for user deposits</p>
          </div>
        </div>
      </div>
    </div>
